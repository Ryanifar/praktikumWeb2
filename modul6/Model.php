    ...
    if (!empty($result)) {
        if ($nama_tabel == "member") {
            foreach ($result as $row) {
                ...
                echo "<td>";
                echo "<a href='FormMember.php?id_member=" . $row['id_member'] . "' class='edit'>edit</a>";
                echo " | ";
                echo "<a href='Member.php?id_member=" . $row['id_member'] . "' onclick=\"return confirm('Yakin Hapus?')\" class='hapus'>Hapus</a>";
                echo "</td>";
                echo "</tr>";
            }
            ...
            foreach ($result as $row) {
                ...
                echo "<td>";
                echo "<a href='FormBuku.php?id_buku=" . $row['id_buku'] . "' class='edit'>edit</a>";
                echo " | ";
                echo "<a href='Buku.php?id_buku=" . $row['id_buku'] . "' onclick=\"return confirm('Yakin Hapus?')\" class='hapus'>Hapus</a>";
                echo "</td>";
                echo "</tr>";
            }
            echo "Menampilkan ".count($result)." data";
            ...
            foreach ($result as $row) {
                ...
                echo "<td>";
                echo "<a href='FormPeminjaman.php?id_peminjaman=" . $row['id_peminjaman'] . "' class='edit'>edit</a>";
                echo " | ";
                echo "<a href='Peminjaman.php?id_peminjaman=" . $row['id_peminjaman'] . "' onclick=\"return confirm('Yakin Hapus?')\" class='hapus'>Hapus</a>";
                echo "</td>";
                echo "</tr>";
            }
            echo "Menampilkan ".count($result)." data";
